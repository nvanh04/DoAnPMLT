$(function () {
    var e, t = $(".datatables-customer-order"), s = {
        1: {
    ...
    t.length && (e = t.DataTable({
        ...
        columnDefs: [{
            ...
            orderable: !1,
            render: function (e, t, a, r) {
                return '<div class="text-xxl-center"><button class="btn btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></button><div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:;" class="dropdown-item">View</a><a href="javascript:;" class="dropdown-item  delete-record">Delete</a></div></div>'
            }
        }],
        order: [[1, "desc"]],
