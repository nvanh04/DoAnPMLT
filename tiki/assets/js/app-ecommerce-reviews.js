!function () {
    let e, t, a, o;
    t = isDarkStyle ? (e = config.colors_dark.cardColor,
        a = config.colors_dark.textMuted,
        o = config.colors_dark.headingColor,
        "dark") : (e = config.colors.cardColor,
    ...
    $(function () {
        let t, a, o;
        o = (isDarkStyle ? (t = config.colors_dark.borderColor,
            ...
            buttons: [{
                ...
                buttons: [{
                    ...
                    customize: function (e) {
                        $(e.document.body).css("color", o).css("border-color", t).css("background-color", a),
