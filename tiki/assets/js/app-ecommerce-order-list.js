$(function () {
    let t, a, s;
    s = (isDarkStyle ? (t = config.colors_dark.borderColor,
    ...
    n.length && (e = n.DataTable({
        ...
        columnDefs: [{
            ...
            render: function (e, t, a, s) {
                var n = a.method
                    , a = a.method_number;
                return "paypal" == n && (a = "@gmail.com"),
                    '<div class="d-flex align-items-center text-nowrap"><img src="' + assetsPath + "img/icons/payments/" + n + '.png" alt="' + n + '" width="29"><span><i class="bx bx-dots-horizontal-rounded mt-1"></i>' + a + "</span></div>"
            }
        }, {
            targets: -1,
            title: "Actions",
