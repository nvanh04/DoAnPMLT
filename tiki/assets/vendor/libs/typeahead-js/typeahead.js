                        ...
                        return s.Bloodhound = (e = t,
                            ...
                            u = function () {
                                ...
                                return n.mixin(i.prototype, {
                                    ...
                                    set: function (t, e, i) {
                                        return n.isNumber(i) ? this._safeSet(this._ttlKey(t), s(r() + i)) : this.ls.removeItem(this._ttlKey(t)),
                                            this._safeSet(this._prefix(t), s(e))
                                    },
                                    remove: function (t) {
                                    ...
                                    n.mixin(u.prototype, {
                                        ...
                                        _get: function (e, n) {
                                            ...
                                            s = this._fingerprint(e),
                                                this.cancelled || s !== this.lastReq || ((o = i[s]) ? o.done(a).fail(c) : t < r ? (t++,
                                                    i[s] = this._send(e).done(a).fail(c).always((function () {
                                                        t--,
                                                            delete i[s],
                                ...
                                return n.mixin(i.prototype, {
                                    ...
                                    add: function (e) {
                                        ...
                                        e = n.isArray(e) ? e : [e],
                                            n.each(e, (function (e) {
                                                var o, u;
                                                i.datums[o = i.identify(e)] = e,
                                                    u = r(i.datumTokenizer(e)),
                                                    n.each(u, (function (e) {
                                                        var n, r, u;
                                                        for (n = i.trie,
                                                            r = e.split(""); u = r.shift();)
                                                            (n = n[t][u] || (n[t][u] = s())).i.push(o)
                                                    }
                                                    ))
                                            }
                                            ))
                                    ...
                                    search: function (e) {
                                        var i, s, o = this;
                                        return i = r(this.queryTokenizer(e)),
                                            n.each(i, (function (e) {
                                                var n, i, r, u;
                                                if (s && 0 === s.length)
                                                    return !1;
                                                for (n = o.trie,
                                                    i = e.split(""); n && (r = i.shift());)
                                                    n = n[t][r];
                                                if (!n || 0 !== i.length)
                                                    return s = [],
                                                        !1;
                            ...
                            f = function () {
                                ...
                                return function (r) {
                                    ...
                                    return s = {
                                        ...
                                        !(r = n.mixin(s, r || {})).datumTokenizer && e.error("datumTokenizer is required"),
                                        ...
                                        r.prefetch = function (r) {
                                            ...
                                            return r ? (s = {
                                                ...
                                                !(r = n.mixin(s, r)).url && e.error("prefetch requires url to be set"),
                                ...
                                return {
                                    ...
                                    trigger: function (n) {
                                        ...
                                        if (!this._callbacks)
                                            return this;
                                        for (n = n.split(t),
                                            o = [].slice.call(arguments, 1); (r = n.shift()) && (s = this._callbacks[r]);)
                                ...
                                return function (i) {
                                    ...
                                    (i = n.mixin({}, e, i)).node && i.pattern && (i.pattern = n.isArray(i.pattern) ? i.pattern : [i.pattern],
                                        ...
                                        function t(e, n) {
                                            ...
                                            var n, s, o;
                                            return (n = r.exec(e.data)) && (o = t.createElement(i.tagName),
                                    ...
                                    n.mixin(i.prototype, s, {
                                        ...
                                        bind: function () {
                                            ...
                                            return e = n.bind(this._onBlur, this),
                                                ...
                                                s = n.bind(this._onInput, this),
                                                this.$input.on("blur.tt", e).on("focus.tt", i).on("keydown.tt", r),
                                                !n.isMsie() || n.isMsie() > 9 ? this.$input.on("input.tt", s) : this.$input.on("keydown.tt keypress.tt cut.tt paste.tt", (function (e) {
                            ...
                            a = function () {
                                ...
                                function r(t, r) {
                                    ...
                                    (t = t || {}).templates = t.templates || {},
                                        ...
                                        t.name && (s = t.name,
                                            !/^[_a-zA-Z0-9-]+$/.test(s)) && e.error("invalid dataset name: " + t.name),
                                        r.mixin(this),
                                        ...
                                        update: function (t) {
                                            ...
                                            function o(e) {
                                                r || (r = !0,
                                                    ...
                                                    s = e.length,
                                                    n._overwrite(t, e),
                                                    s < n.limit && n.async && n.trigger("asyncRequested", t))
                                            }
                                            this.cancel(),
                                                ...
                                                this.source(t, o, (function (r) {
                                                    r = r || [],
                                                        !i && s < n.limit && (n.cancel = e.noop,
                                                            s += r.length,
                                                            n._append(t, r.slice(0, n.limit - s)),
                                ...
                                return n.mixin(t.prototype, {
                                    ...
                                    _updateHint: function () {
                                        ...
                                        t = this.menu.getTopSelectable(),
                                            ...
                                            !e || n.isBlankString(i) || this.input.hasOverflow() ? this.input.clearHint() : (r = u.normalizeQuery(i),
                                                s = n.escapeRegExChars(r),
                                                (o = new RegExp("^(?:" + s + ")(.+$)", "i").exec(e.val)) && this.input.setHint(i + o[1]))
                                    },
                                    isEnabled: function () {
                                        return this.enabled
                                    },
                                ...
                                t = e.fn.typeahead,
                                    ...
                                    o = {
                                        initialize: function (t, o) {
                                            var a;
                                            return o = n.isArray(o) ? o : [].slice.call(arguments, 1),
                                                a = i((t = t || {}).classNames),
                                                this.each((function () {
                                                    var i, d, p, g, m, y, v, _, b, w, S;
                                                    n.each(o, (function (e) {
                                                        ...
                                                        y && (g = e(a.html.menu).css(a.css.menu)),
                                                        p && p.val(""),
                                                        i = function (t, e) {
                                                            t.data(s.attrs, {
                                                                dir: t.attr("dir"),
                                                        ...
                                                        (m || y) && (d.css(a.css.wrapper),
                                                            i.css(m ? a.css.input : a.css.inputWithNoHint),
                                                            i.wrap(d).parent().prepend(m ? p : null).append(y ? g : null)),
                                                        S = y ? h : c,
                                                        v = new r({
                                                            el: i
                                                        }),
