        ...
        var t = {
            840: function (t, e, n) {
                ...
                !function (r, s, o, a) {
                        ...
                        n.isFirst = !!s,
                            ...
                            function (t, e) {
                                ...
                                n.firstInput || (n.firstInput = it(e)),
                                    r > 1 && !n.firstMultiple ? n.firstMultiple = it(e) : 1 === r && (n.firstMultiple = !1);
                                var s = n.firstInput
                                    , o = n.firstMultiple
                                ...
                                e.timeStamp = v(),
                                    ...
                                    function (t, e) {
                                        var n = e.center
                                            ...
                                            , r = t.prevDelta || {}
                                            , s = t.prevInput || {};
                                        e.eventType !== k && s.eventType !== L || (r = t.prevDelta = {
                                            x: s.deltaX || 0,
                                            y: s.deltaY || 0
                                        },
                                            i = t.offsetDelta = {
                                ...
                                e.overallVelocityX = p.x,
                                    ...
                                    e.scale = o ? (c = o.pointers,
                                        at((l = i)[0], l[1], tt) / at(c[0], c[1], tt)) : 1,
                                    ...
                                    function (t, e) {
                                        ...
                                        if (e.eventType != H && (u > j || o.velocity === a)) {
                    ...
                    function ot(t, e) {
                        return t === e ? U : f(t) >= f(e) ? t < 0 ? V : G : e < 0 ? Z : B
                    }
                    function at(t, e, n) {
                        n || (n = Q);
                        var i = e[n[0]] - t[n[0]]
                    ...
                    b(pt, et, {
                        handler: function (t) {
                            ...
                            e & k && 0 === t.button && (this.pressed = !0),
                                2 & e && 1 !== t.which && (e = L),
                                this.pressed && (e & L && (this.pressed = !1),
                    ...
                    r.MSPointerEvent && !r.PointerEvent && (dt = "MSPointerDown",
                    ...
                    function Et(t, e) {
                        ...
                        return e & (L | H) && (n = M(n.concat(i), "identifier", !0)),
                            [n, i]
                    }
                    b(Tt, et, {
                        handler: function (t) {
                            ...
                            if (e === k && (this.started = !0),
                                ...
                                e & (L | H) && n[0].length - n[1].length == 0 && (this.started = !1),
                                    this.callback(this.manager, e, {
                                        pointers: n[0],
                                        changedPointers: n[1],
                                        pointerType: W,
                    ...
                    function xt(t, e) {
                        t & k ? (this.primaryTouch = e.changedPointers[0].identifier,
                            Ct.call(this, e)) : t & (L | H) && Ct.call(this, e)
                    }
                    function Ct(t) {
                    ...
                    Wt.prototype = {
                        set: function (t) {
                            t == Mt && (t = this.compute()),
                                wt && this.manager.element.style && Ft[t] && (this.manager.element.style[Ot] = t),
                        ...
                        compute: function () {
                            ...
                            return g(this.manager.recognizers, (function (e) {
                                ...
                                function (t) {
                                    ...
                                    var e = C(t, Xt)
                                        , n = C(t, Yt);
                                    return e && n ? Nt : e || n ? e ? Xt : Yt : C(t, zt) ? zt : Rt
                                }(t.join(" "))
                        },
                        preventDefaults: function (t) {
                            ...
                            if (this.manager.session.prevented)
                                ...
                                if (!o || !s)
                                    return r || s && n & $ || o && n & J ? this.preventSrc(e) : void 0
                            }
                        },
                    ...
                    function Ht(t) {
                        return t == B ? "down" : t == Z ? "up" : t == V ? "left" : t == G ? "right" : ""
                    }
                    function Ut(t, e) {
                        var n = e.manager;
                        return n ? n.get(t) : t
                    ...
                    function Qt(t, e) {
                        return (e = e || {}).recognizers = S(e.recognizers, Qt.defaults.preset),
                            new te(t, e)
                    }
                    function te(t, e) {
                        this.options = u({}, Qt.defaults, e || {}),
                            ...
                            this.oldCssProps = {},
                            this.element = t,
                            this.input = new (this.options.inputClass || (Y ? gt : F ? At : X ? Pt : pt))(this, nt),
                    ...
                    kt.prototype = {
                        ...
                        dropRecognizeWith: function (t) {
                            return m(t, "dropRecognizeWith", this) || (t = Ut(t, this),
                        ...
                        requireFailure: function (t) {
                            ...
                            return -1 === O(e, t = Ut(t, this)) && (e.push(t),
                        ...
                        canEmit: function () {
                            for (var t = 0; t < this.requireFail.length;) {
                                if (!(this.requireFail[t].state & (jt | qt)))
                                    return !1;
                                t++
                            }
                            return !0
                        ...
                        b(Vt, kt, {
                            ...
                            process: function (t) {
                                var e = this.state
                                    ...
                                    , i = 6 & e
                                    , r = this.attrTest(t);
                                return i && (n & H || !r) ? 16 | e : i || r ? n & L ? 8 | e : 2 & e ? 4 | e : 2 : jt
                            }
                        }),
                        b(Gt, Vt, {
                            defaults: {
                            ...
                            directionTest: function (t) {
                                var e = this.options
                                    ...
                                    , s = t.deltaX
                                    , o = t.deltaY;
                                return r & e.direction || (e.direction & $ ? (r = 0 === s ? U : s < 0 ? V : G,
                                    n = s != this.pX,
                                    i = Math.abs(t.deltaX)) : (r = 0 === o ? U : o < 0 ? Z : B,
                                        n = o != this.pY,
                                        i = Math.abs(t.deltaY))),
                                    t.direction = r,
                        ...
                        b(Bt, kt, {
                            ...
                            emit: function (t) {
                                8 === this.state && (t && t.eventType & L ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = v(),
                        ...
                        b(Jt, Vt, {
                            ...
                            attrTest: function (t) {
                                ...
                                return n & ($ | J) ? e = t.overallVelocity : n & $ ? e = t.overallVelocityX : n & J && (e = t.overallVelocityY),
                                    this._super.attrTest.call(this, t) && n & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && f(e) > this.options.velocity && t.eventType & L
                            },
                            emit: function (t) {
